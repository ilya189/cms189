$(document).ready(function() {
    $(".autoload_ch").live("click", function() {
        ...
        var $this = $(this);
        $.ajax({type: "post", data: "mid=" + mid, dataType: "json", url: "/admin/components/change_autoload", success: function(obj) {
                if (obj.result === false) {
    ...
    $(".urlen_ch").live("click", function() {
        ...
        if (!$(this).hasClass("disabled")) {
            $.ajax({type: "post", data: "mid=" + mid, dataType: "json", url: "/admin/components/change_url_access", success: function(obj) {
                    if (obj.result === false) {
    ...
    $(".mod_instal").live("click", function() {
        var mname = $(this).attr("data-mname");
        var $this = $(this);
        $.ajax({type: "post", dataType: "json", url: "/admin/components/install/" + mname, success: function(obj) {
                if (obj.result === true) {
    ...
    $(".show_in_menu").live("click", function() {
        ...
        $.ajax({url: "/admin/components/change_show_in_menu", data: "id=" + id, type: "post", success: function(data) {
    ...
    $(".lan_def").live("click", function() {
        ...
        var th = $(this);
        $.ajax({type: "post", url: "/admin/languages/set_default", data: "lang=" + id, success: function(data) {
    ...
    $(".submit_form").live("click", function() {
        var options = {dataType: "json", success: function(obj) {
                if (obj.result === false) {
    ...
    $(".currency_def").live("click", function() {
        ...
        $.ajax({type: "post", data: "id=" + currency_id, url: "/admin/components/run/shop/currencies/makeCurrencyDefault", success: function(data) {
                if (data) {
    ...
    $(".currency_main").live("click", function() {
        var currency_id = $(this).data("currid");
        $.ajax({type: "post", data: "id=" + currency_id, url: "/admin/components/run/shop/currencies/makeCurrencyMain", success: function(data) {
                if (data) {
    ...
    $("#generateButton").live("click", function() {
        $.ajax({type: "post", dataType: "json", url: "/admin/components/run/shop/gifts/generateKey", success: function(obj) {
    ...
    $(".ch_active").live("click", function() {
        ...
        var $this = $(this);
        $.ajax({type: "post", url: "/admin/components/run/shop/gifts/ChangeActive/" + cid, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    $(".comment_update").live("click", function() {
        ...
        $.ajax({type: "post", url: "/admin/components/cp/comments/update", data: "id=" + id + "&user_name=" + user_name + "&user_mail=" + user_mail + "&text=" + text + "&status=" + status + "&text_plus=" + text_plus + "&text_minus=" + text_minus, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    $(".to_spam").live("click", function() {
        var id = $(this).attr("data-id");
        $.ajax({type: "post", url: "/admin/components/cp/comments/update_status", data: "id=" + id + "&status=" + 2, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    dropDownMenu();
    $("#comment_delete").live("click", function() {
        if ($(this).hasClass("disabled")) {
            ...
            $.post("/admin/components/cp/comments/delete", {id: arr}, function(data) {
                $(".notifications").append(data);
            });
        }
    });
    $(".com_del").live("click", function() {
        var id = $(this).attr("data-id");
        $.post("/admin/components/cp/comments/delete", {id: id}, function(data) {
            $(".notifications").append(data);
        });
    });
    $(".to_approved").live("click", function() {
        var id = $(this).attr("data-id");
        $.ajax({type: "post", url: "/admin/components/cp/comments/update_status", data: "id=" + id + "&status=" + 0, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    $(".to_waiting").live("click", function() {
        var id = $(this).attr("data-id");
        $.ajax({type: "post", url: "/admin/components/cp/comments/update_status", data: "id=" + id + "&status=" + 1, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    ...
    $("#translateCategoryTitle").live("click", function() {
        ...
        $.ajax({type: "post", url: "/admin/components/run/shop/categories/ajax_translit", data: "str=" + str, success: function(data) {
                $("#inputUrl").attr("value", data);
            }});
    });
    $(".cat_change_active").live("click", function() {
        var id = $(this).attr("data-id");
        $.ajax({type: "post", url: "/admin/components/run/shop/categories/changeActive", data: "id=" + id, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    $("#create_tpl").live("click", function() {
        ...
        if (name != null && name != "") {
            $.ajax({type: "post", dataType: "json", url: "/admin/components/run/shop/categories/create_tpl", data: "filename=" + name, success: function(obj) {
    ...
    $(".prop_active").live("click", function() {
        var id = $(this).attr("data-id");
        $.ajax({type: "post", url: "/admin/components/run/shop/properties/changeActive", data: "id=" + id, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    function save_positions(url) {
        ...
        $.post(url, {positions: arr}, function(data) {
            $(".notifications").append(data);
        });
    }
    $(".kit_change_active").live("click", function() {
        var id = $(this).attr("data-kid");
        $.ajax({type: "post", url: "/admin/components/run/shop/kits/kit_change_active/" + id, success: function(data) {
                $(".notifications").append(data);
            }});
    ...
    product.toHit = function() {
        ...
        $.post("/admin/components/run/shop/products/ajaxChangeHit", {ids: ids}, function(data) {
            $(".notifications").append(data);
        });
    };
    product.toNew = function() {
        ...
        $.post("/admin/components/run/shop/products/ajaxChangeHot", {ids: ids}, function(data) {
            $(".notifications").append(data);
        });
    };
    product.toAction = function() {
        ...
        $.post("/admin/components/run/shop/products/ajaxChangeAction", {ids: ids}, function(data) {
            $(".notifications").append(data);
        });
    };
    product.cloneTo = function() {
        ...
        $.post("/admin/components/run/shop/products/ajaxCloneProducts", {ids: ids}, function(data) {
            $(".notifications").append(data);
        });
    };
    ...
    $(".item_hidden").live("click", function() {
        var id = $(this).attr("data-id");
        $.ajax({type: "post", url: "/admin/components/cp/menu/change_hidden", data: "id=" + id, success: function(data) {
                $(".notifications").append(data);
            }});
    });
    $("#category_sel").live("change", function() {
        ...
        $.ajax({type: "post", dataType: "json", data: "per_page=" + per_page, url: "/admin/components/run/menu/get_pages/" + id + "/0", success: function(obj) {
                if (obj) {
                    var st = "";
    ...
    $(".product_list_order").live("click", function() {
        ...
        $.pjax({url: "/admin/components/run/shop/search/index/?" + query_string, container: "#mainContent"});
    });
    $(".move_to_cat").live("click", function() {
        ...
        $.post("/admin/components/run/shop/products/ajaxMoveProducts", {ids: ids, categoryId: catId}, function(data) {
            $(".notifications").append(data);
        });
    });
    ...
    $(".kit_del_ok").live("click", function() {
        ...
        $.ajax({url: "/admin/components/run/shop/kits/kit_delete", data: "ids=" + id, type: "post", success: function(data) {
    ...
    $(".item_parent_id").live("change", function() {
        ...
        $.ajax({type: "post", url: "/admin/components/cp/menu/get_children_items/" + id + "/" + menu_id, success: function(data) {
...
$(document).ready(function() {
    ...
    $("#role_id").live("change", function() {
        ...
        $.ajax({dataType: "html", headers: {"X-PJAX": "X-PJAX"}, url: "/admin/components/cp/user_manager/getRolesTable/" + $roleId, success: function(msg) {
                $("#privilege").html(msg);
            }});
    });
    ...
    $(".clearCashe").live("click", function() {
        $this = $(this);
        $.ajax({type: "post", dataType: "json", data: "param=" + $this.attr("data-param"), url: $this.data("target"), success: function(obj) {
                if (obj.result == true) {
    ...
    $(".saveButton").live("click", function() {
        ...
        $.ajax({type: "post", dataType: "json", data: $(".saveForm").serialize(), url: "/admin/components/cp/menu/update_menu/" + idMenu, success: function(obj) {
                if (obj.result == true) {
    ...
    $(".createMenu").live("click", function() {
        $.ajax({type: "post", dataType: "json", data: $(".createMenuForm").serialize(), url: "/admin/components/cp/menu/create_menu/", success: function(obj) {
                if (obj.result == true) {
...
var delete_function = new Object({deleteFunction: function() {
...
var delete_functionS = new Object({deleteFunctionS: function() {
...
var delete_currency_function = new Object({deleteFunction: function(cid) {
        $("#first").modal();
        id = cid;
        return id;
    }, deleteFunctionConfirm: function(href) {
...
var pagesAdmin = new Object({quickAddCategory: function() {
        if ($("#fast_add_form").valid()) {
            $("#fast_add_form").ajaxSubmit({success: function(responseText) {
        ...
        $.ajax({url: "/admin/components/cp/cfcm/form_from_category_group/" + categoryId + "/0/page", type: "GET", headers: {"X-PJAX": "X-PJAX"}, complete: function(data) {
                $("#cfcm_fields_block").append(data.responseText);
            }});
    }, loadCFEditPage: function() {
        var updatePageId = $("#edit_page_form").data("pageid");
        var categoryId = $("#category_selectbox").val();
        $.ajax({url: "/admin/components/cp/cfcm/form_from_category_group/" + categoryId + "/" + updatePageId + "/page", type: "GET", headers: {"X-PJAX": "X-PJAX"}, complete: function(data) {
                $("#cfcm_fields_block").append(data.responseText);
            }});
...
var CFAdmin = new Object({deleteOne: function(label) {
...
$(document).ready(function() {
    $(".pages-table").live("sortstop", function(event, ui) {
        ...
        $.ajax({type: "post", data: positionsArray, url: "/admin/pages/save_positions/", success: function(obj) {
                if (obj.result) {
                }
            }});
    });
    ...
    $(".products_table").find("span.prod-on_off").live("click", function() {
        ...
        $.ajax({type: "POST", url: base_url + "admin/components/run/shop/products/ajaxChangeActive/" + page_id, onComplete: function(response) {
            }});
    });
    $(".products_table").find("button.setHit").live("click", function() {
        var btn = $(this);
        $.ajax({type: "POST", url: base_url + "admin/components/run/shop/products/ajaxChangeHit/" + btn.attr("data-id"), onComplete: function(response) {
            }});
        btn.toggleClass("btn-primary active");
    });
    $(".products_table").find("button.setHot").live("click", function() {
        var btn = $(this);
        $.ajax({type: "POST", url: base_url + "admin/components/run/shop/products/ajaxChangeHot/" + btn.attr("data-id"), onComplete: function(response) {
            }});
        btn.toggleClass("btn-primary active");
    });
    $(".products_table").find("button.setAction").live("click", function() {
        var btn = $(this);
        $.ajax({type: "POST", url: base_url + "admin/components/run/shop/products/ajaxChangeAction/" + btn.attr("data-id"), onComplete: function(response) {
            }});
        btn.toggleClass("btn-primary active");
    });
    $("button.refresh_price").live("click", function() {
        ...
        $.ajax({type: "POST", data: variantId, url: base_url + "admin/components/run/shop/products/ajaxUpdatePrice/" + btn.attr("data-id"), success: function(data) {
                $(".notifications").append(data);
            }});
    });
