...
class MY_Cart extends CI_Cart {
    ...
    var $product_name_rules	= '\w \"\+\_\'\-\.\:\/\\ 0-9'; // alpha-numeric, dashes, underscores, colons or periods
    ...
    function get_code($items = array()){
        ...
        if (isset($this->_cart_contents[$rowid]['rowid']) && $this->_cart_contents[$rowid]['rowid'] == $rowid){
            return array('code'=>$rowid,'qty'=>$this->_cart_contents[$rowid]['qty']);
        }
        else{
            return false;
        }
